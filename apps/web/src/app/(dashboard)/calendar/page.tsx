  ...
  const calendarItems: CalendarItem[] = [
    {
      ...
      date: 14,
      status: 'Rendering',
      thumbnail: `https://image.pollinations.ai/prompt/${encodeURIComponent('Top 5 AI Automation Hacks for 2026 16:9')}&width=600&height=338&seed=3124&nologo=true`,
      scriptSnippet:
    ...
    },
    {
      ...
      thumbnail: `https://image.pollinations.ai/prompt/${encodeURIComponent('3 Secret Code Hacks You Didnt Know 16:9')}&width=600&height=338&seed=8173&nologo=true`,
    ...
    },
    {
      ...
      date: 16,
      status: 'Scheduled',
      thumbnail: `https://image.pollinations.ai/prompt/${encodeURIComponent('How NVIDIA Quantum AI is Changing Everything 16:9')}&width=600&height=338&seed=5512&nologo=true`,
    ...
    },
    {
      ...
      date: 17,
      status: 'Scheduled',
      thumbnail: `https://image.pollinations.ai/prompt/${encodeURIComponent('AI vs Human Graphic Designers Test 16:9')}&width=600&height=338&seed=9928&nologo=true`,
    ...
    },
    {
      ...
      date: 12,
      status: 'Published',
      thumbnail: `https://image.pollinations.ai/prompt/${encodeURIComponent('The Ultimate AI Content Engine Walkthrough 16:9')}&width=600&height=338&seed=7712&nologo=true`,
